      ...
      <div className="space-y-8">
        <div className="flex items-center">
          ...
          <div className="ml-4 space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Troca de óleo e inspeção de freios</p>
          </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Serviço de transmissão</p>
          </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4 space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Rodízio e alinhamento de pneus</p>
          </div>
